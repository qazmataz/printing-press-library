...
Data must be synced first with the sync command.`,
  ...
  alltrails-pp-cli analytics --type messages

  # Group by a field
  alltrails-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  alltrails-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			out := cmd.OutOrStdout()
			if dbPath == "" {
				dbPath = defaultDBPath("alltrails-pp-cli")
			}
