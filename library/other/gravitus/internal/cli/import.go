...
but do not stop the import.`,
  ...
  gravitus-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  gravitus-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | gravitus-pp-cli import <resource> --input -`,
