...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/usgs-earthquakes/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "usgs-earthquakes-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
