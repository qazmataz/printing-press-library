...
large datasets as it has no memory pressure.`,
  ...
  usgs-earthquakes-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  usgs-earthquakes-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  usgs-earthquakes-pp-cli export <resource> --format jsonl | jq '.id'`,
