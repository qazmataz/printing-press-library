...
but do not stop the import.`,
  ...
  usgs-earthquakes-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  usgs-earthquakes-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | usgs-earthquakes-pp-cli import <resource> --input -`,
