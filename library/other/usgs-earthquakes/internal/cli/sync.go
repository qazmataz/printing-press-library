...
Resource scoping:
  ...
  usgs-earthquakes-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  usgs-earthquakes-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  usgs-earthquakes-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  usgs-earthquakes-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  usgs-earthquakes-pp-cli sync --latest-only`,
...
var pageItemKeys = []string{
	"data", "results", "items", "records", "nodes", "entries", "features", "features", "features",
	"Data", "Results", "Items", "Records", "Nodes", "Entries", "Features", "Features", "Features",
}
