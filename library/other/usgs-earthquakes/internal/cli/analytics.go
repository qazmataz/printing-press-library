...
Data must be synced first with the sync command.`,
  ...
  usgs-earthquakes-pp-cli analytics --type messages

  # Group by a field
  usgs-earthquakes-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  usgs-earthquakes-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
