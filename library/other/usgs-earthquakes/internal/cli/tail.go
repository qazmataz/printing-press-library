...
native streaming instead of polling.`,
  ...
  usgs-earthquakes-pp-cli tail --interval 10s

  # Tail a specific resource
  usgs-earthquakes-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  usgs-earthquakes-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
