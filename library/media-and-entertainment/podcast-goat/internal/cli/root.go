...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "podcast-goat-pp-cli",
		Short: `Podcast Goat CLI — Pull long-form podcast transcripts as speaker-labeled markdown — cookie-first across the four major paid publishers, fr…`,
		Long: `Podcast Goat CLI — Pull long-form podcast transcripts as speaker-labeled markdown — cookie-first across the four major paid publishers, fr…
...
Health check: run 'podcast-goat-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("podcast-goat-pp-cli {{ .Version }}\n")
	...
	rootCmd.AddCommand(newEpisodeCmd(flags))
	...
	// PATCH: v0.1 novel commands.
	rootCmd.AddCommand(newMagicCmd(flags))
	rootCmd.AddCommand(newCacheCmd(flags))
	rootCmd.AddCommand(newFeedsCmd(flags))
