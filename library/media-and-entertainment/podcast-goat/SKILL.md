...
This CLI ships a self-learning loop. When you run podcast-goat-pp-cli commands, the binary
...
`podcast-goat-pp-cli --no-learn <command>`) to disable the loop's side effects for
one invocation.
