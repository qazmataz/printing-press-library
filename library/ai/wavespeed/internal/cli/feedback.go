...
func FeedbackEndpointConfigured() bool {
	return os.Getenv("WAVESPEED_FEEDBACK_ENDPOINT") != ""
}
...
func feedbackAutoSend() bool {
	v := strings.ToLower(strings.TrimSpace(os.Getenv("WAVESPEED_FEEDBACK_AUTO_SEND")))
...
func postFeedback(url string, entry FeedbackEntry) error {
	...
	req.Header.Set("User-Agent", "wavespeed-pp-cli/feedback")
