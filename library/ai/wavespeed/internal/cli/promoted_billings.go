...
func newBillingsPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "billings",
		Short:       "Search billing records for the authenticated account.",
		Long:        "Search billing records for the authenticated account.",
		Example:     "  wavespeed-pp-cli billings",
		Annotations: map[string]string{"pp:endpoint": "billings.search", "pp:method": "POST", "pp:path": "/billings/search", "mcp:read-only": "true"},
