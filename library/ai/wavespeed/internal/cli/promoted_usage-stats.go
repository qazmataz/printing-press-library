...
func newUsageStatsPromotedCmd(flags *rootFlags) *cobra.Command {
	var bodyCreatedAfter string
	var bodyCreatedBefore string

	cmd := &cobra.Command{
		Use:         "usage-stats",
		Short:       "Retrieve usage statistics for the authenticated account.",
		Long:        "Retrieve usage statistics for the authenticated account.",
		Example:     "  wavespeed-pp-cli usage-stats",
		Annotations: map[string]string{"pp:endpoint": "usage_stats.get", "pp:method": "POST", "pp:path": "/user/usage_stats", "mcp:read-only": "true"},
