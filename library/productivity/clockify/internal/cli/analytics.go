...
Data must be synced first with the sync command.`,
  ...
  clockify-pp-cli analytics --type messages

  # Group by a field
  clockify-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  clockify-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
