...
but do not stop the import.`,
  ...
  clockify-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  clockify-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | clockify-pp-cli import <resource> --input -`,
