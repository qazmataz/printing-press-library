...
Resource scoping:
  ...
  clockify-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  clockify-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  clockify-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  clockify-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  clockify-pp-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "addons_webhooks":
		return db.UpsertAddonsWebhooks(data)
	case "approval-requests":
		return db.UpsertApprovalRequests(data)
	case "clients":
		return db.UpsertClients(data)
	case "cost-rate":
		return db.UpsertCostRate(data)
	case "custom-fields":
		return db.UpsertCustomFields(data)
	case "entities":
		return db.UpsertEntities(data)
	case "expenses":
		return db.UpsertExpenses(data)
	case "files":
		return db.UpsertFiles(data)
	case "file":
		return db.UpsertFile(data)
	case "holidays":
		return db.UpsertHolidays(data)
	case "hourly-rate":
		return db.UpsertHourlyRate(data)
	case "invoices":
	...
	case "member-profile":
		return db.UpsertMemberProfile(data)
	case "projects":
		return db.UpsertProjects(data)
	case "projects_custom_fields":
		return db.UpsertProjectsCustomFields(data)
	case "estimate":
		return db.UpsertEstimate(data)
	case "memberships":
		return db.UpsertMemberships(data)
	case "tasks":
		return db.UpsertTasks(data)
	case "template":
		return db.UpsertTemplate(data)
	case "projects_users":
		return db.UpsertProjectsUsers(data)
	case "scheduling":
		return db.UpsertScheduling(data)
	case "tags":
	...
	case "time-off":
		return db.UpsertTimeOff(data)
	case "user":
		return db.UpsertUser(data)
	case "user_time_entries":
		return db.UpsertUserTimeEntries(data)
	case "user-groups":
		return db.UpsertUserGroups(data)
	case "user_groups_users":
		return db.UpsertUserGroupsUsers(data)
	case "users":
		return db.UpsertUsers(data)
	case "users_cost_rate":
		return db.UpsertUsersCostRate(data)
	case "custom_field":
		return db.UpsertCustomField(data)
	case "users_hourly_rate":
		return db.UpsertUsersHourlyRate(data)
	case "managers":
		return db.UpsertManagers(data)
	case "roles":
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "approval_requests", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/approval-requests", KeyField: ""},
		{Name: "clients", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/clients", KeyField: ""},
		{Name: "entities", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/entities/created", KeyField: ""},
		{Name: "expenses", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/expenses", KeyField: ""},
		{Name: "invoices", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/invoices", KeyField: ""},
		{Name: "managers", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/users/{userId}/managers", KeyField: ""},
		{Name: "payments", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/invoices/{invoiceId}/payments", KeyField: ""},
		{Name: "projects", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/projects", KeyField: ""},
		{Name: "scheduling", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/scheduling/assignments/users/{userId}/totals", KeyField: ""},
		{Name: "tags", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/tags", KeyField: ""},
		{Name: "tasks", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/projects/{projectId}/tasks", KeyField: ""},
		{Name: "templates", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/templates", KeyField: ""},
		{Name: "time_off", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/time-off/balance/policy/{policyId}", KeyField: ""},
		{Name: "user_groups", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/user-groups", KeyField: ""},
		{Name: "user_time_entries", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/user/{userId}/time-entries", KeyField: ""},
		{Name: "workspaces_time_entries", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/time-entries/status/in-progress", KeyField: ""},
		{Name: "workspaces_users", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v1/workspaces/{workspaceId}/users", KeyField: ""},
	}
}
