...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/clockify/internal/mcp"
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "clockify-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
