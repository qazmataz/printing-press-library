...
large datasets as it has no memory pressure.`,
  ...
  strava-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  strava-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  strava-pp-cli export <resource> --format jsonl | jq '.id'`,
