...
but do not stop the import.`,
  ...
  strava-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  strava-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | strava-pp-cli import <resource> --input -`,
