...
Data must be synced first with the sync command.`,
  ...
  appmagic-pp-cli analytics --type messages

  # Group by a field
  appmagic-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  appmagic-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
