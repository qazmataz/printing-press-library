...
large datasets as it has no memory pressure.`,
  ...
  appmagic-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  appmagic-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  appmagic-pp-cli export <resource> --format jsonl | jq '.id'`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				...
				"publishers":          true,
				"tags":                true,
				"united-applications": true,
				"united-publishers":   true,
			}
