...
func newApplicationsGetByIdsCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "get-by-ids",
		Short:       "Retrieves the App Info data for the array of apps with selected IDs.",
		Example:     "  appmagic-pp-cli applications get-by-ids",
		Annotations: map[string]string{"pp:endpoint": "applications.get-by-ids", "pp:method": "POST", "pp:path": "/applications/search-by-ids"},
