...
Resource scoping:
  ...
  appmagic-pp-cli sync

  # Sync specific resources only
  appmagic-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  appmagic-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  appmagic-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  appmagic-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  appmagic-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/appmagic-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "competitors":
		return db.UpsertCompetitors(data)
	case "info":
		return db.UpsertInfo(data)
	case "release_notes":
		return db.UpsertReleaseNotes(data)
	case "screenshots":
		return db.UpsertScreenshots(data)
	case "similarity":
		return db.UpsertSimilarity(data)
	case "publishers_applications":
		return db.UpsertPublishersApplications(data)
	case "united_applications_data_countries":
		return db.UpsertUnitedApplicationsDataCountries(data)
	case "ltv":
		return db.UpsertLtv(data)
	case "united_publishers_data_countries":
		return db.UpsertUnitedPublishersDataCountries(data)
	case "united_publishers_united_applications":
		return db.UpsertUnitedPublishersUnitedApplications(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		...
		"last-versions",
		"live-ops-live-ops",
		"live-ops-live-ops-calendar",
		"live-ops-tags-values",
		"live-ops-updates",
		"period-comparison",
		"sdkint",
		"steam",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"adint":                      "/adint/filter_values",
		"app-categories":             "/app_categories",
		"app-publishers":             "/app_publishers",
		"app-tags":                   "/app_tags",
		"app-transfers":              "/app-transfers",
		"apps-downloads":             "/apps_downloads",
		"categories":                 "/categories",
		"country-downloads":          "/country_downloads",
		"last-date":                  "/last-date",
		"last-versions":              "/last_versions",
		"live-ops":                   "/live-ops/games",
		"live-ops-live-ops":          "/live-ops/live-ops",
		"live-ops-live-ops-calendar": "/live-ops/live-ops-calendar",
		"live-ops-tags-values":       "/live-ops/tags-values",
		"live-ops-updates":           "/live-ops/updates",
		"period-comparison":          "/period-comparison/last-date",
		"sdkint":                     "/sdkint/sdks/all",
		"steam":                      "/steam/tags",
		"steam-app-united":           "/steam/app/united",
		"steam-categories":           "/steam/categories",
		"steam-genres":               "/steam/genres",
		"tags":                       "/tags",
		"tops":                       "/tops/ltv",
	}
