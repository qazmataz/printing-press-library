...
but do not stop the import.`,
  ...
  appmagic-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  appmagic-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | appmagic-pp-cli import <resource> --input -`,
