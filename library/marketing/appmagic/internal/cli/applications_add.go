...
func newApplicationsAddCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Submits an array of app IDs that are missing from our system. In 48 hours or less, their data will be added.",
		Example:     "  appmagic-pp-cli applications add",
		Annotations: map[string]string{"pp:endpoint": "applications.add", "pp:method": "POST", "pp:path": "/applications"},
