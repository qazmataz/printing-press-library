...
but do not stop the import.`,
  ...
  botsee-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  botsee-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | botsee-pp-cli import <resource> --input -`,
