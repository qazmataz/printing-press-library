...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "botsee-pp-cli",
		Short: `Botsee CLI — Have your agents measure and improve your brand's AI Visibility with botsee.io. API-first, agent-native.`,
		Long: `Botsee CLI — Have your agents measure and improve your brand's AI Visibility with botsee.io. API-first, agent-native.
...
Health check: run 'botsee-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("botsee-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'botsee-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAnalysisCmd(flags))
	rootCmd.AddCommand(newApiKeysCmd(flags))
	rootCmd.AddCommand(newBillingCmd(flags))
	rootCmd.AddCommand(newCustomerTypesCmd(flags))
	rootCmd.AddCommand(newPersonasCmd(flags))
	rootCmd.AddCommand(newQuestionsCmd(flags))
	rootCmd.AddCommand(newSignupCmd(flags))
	rootCmd.AddCommand(newSitesCmd(flags))
	rootCmd.AddCommand(newUsageCmd(flags))
	...
	rootCmd.AddCommand(newBotseeAuthPromotedCmd(flags))
	rootCmd.AddCommand(newPricingPromotedCmd(flags))
	rootCmd.AddCommand(newRateLimitsPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())

	// Novel features (hand-coded transcendence commands).
	rootCmd.AddCommand(newAIVisibilityAuditCmd(flags))
	rootCmd.AddCommand(newAnalyzeCmd(flags))
	rootCmd.AddCommand(newRecommendationsCmd(flags))
	rootCmd.AddCommand(newSiteConfigCmd(flags))
	rootCmd.AddCommand(newSitesSummaryCmd(flags))
