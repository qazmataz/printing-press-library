...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "namecheap-pp-cli",
		Short: "Manage namecheap resources via the namecheap API",
		Long: `Manage namecheap resources via the namecheap API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'namecheap-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("namecheap-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'namecheap-pp-cli profile list')")
	...
	rootCmd.AddCommand(newXmlResponseCmd(flags))
