...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/sales-and-crm/tenderned/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "tenderned-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
