...
func newDocsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list <publicatieId>",
		Short:       "List attached documents for one publication",
		Example:     "  tenderned-pp-cli docs list 42",
		Annotations: map[string]string{"pp:endpoint": "docs.list", "pp:method": "GET", "pp:path": "/publicaties/{publicatieId}/documenten", "mcp:read-only": "true"},
