...
In local mode: searches locally synced data only.`,
  ...
  tenderned-pp-cli search "error timeout"

  # Force local search only
  tenderned-pp-cli search "payment failed" --data-source local

  # Search a specific resource type locally
  tenderned-pp-cli search "critical" --type transactions --data-source local

  # JSON output for piping
  tenderned-pp-cli search "critical" --json --limit 20`,
