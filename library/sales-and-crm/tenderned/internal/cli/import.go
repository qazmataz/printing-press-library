...
but do not stop the import.`,
  ...
  tenderned-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  tenderned-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | tenderned-pp-cli import <resource> --input -`,
