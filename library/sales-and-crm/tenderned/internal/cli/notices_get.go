...
func newNoticesGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <publicatieId>",
		Short:       "Fetch full structured metadata for one publication",
		Example:     "  tenderned-pp-cli notices get 42",
		Annotations: map[string]string{"pp:endpoint": "notices.get", "pp:method": "GET", "pp:path": "/publicaties/{publicatieId}", "mcp:read-only": "true"},
