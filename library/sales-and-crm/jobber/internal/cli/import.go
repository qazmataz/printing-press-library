...
but do not stop the import.`,
  ...
  jobber-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  jobber-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | jobber-pp-cli import <resource> --input -`,
